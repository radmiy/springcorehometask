package com.epam.spring.hometask.beans;

import com.epam.spring.hometask.utils.GenIdUtil;
...
public class Event extends DomainObject {
    ...
    public Event(String name, NavigableSet<LocalDateTime> airDates,
                 double basePrice, EventRating rating,
        ...
        super.setId(GenIdUtil.getId(Event.class));
    }
